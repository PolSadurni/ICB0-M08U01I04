...
class PeliculaDetalle extends StatelessWidget {
  ...
  Widget _crearCasting(Actor pelicula) {
    final peliProvider = new PeliculasProvider();

    return FutureBuilder(
      future: peliProvider.getCredit(pelicula.id.toString()),
  ...
  Widget _crearActoresPageView(List<Pelicula> actores) {
    return SizedBox(
      height: 200.0,
  ...
  Widget _actorTarjeta(Pelicula actor) {
    return Container(
        child: Column(
      children: <Widget>[
        ClipRRect(
